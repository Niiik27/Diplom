...
path(APP_NAMES.TEAM_DELETE_USER[APP_NAMES.NAME], views.TeamDeleteUser.as_view(), name=APP_NAMES.TEAM_DELETE_USER[APP_NAMES.NAME]),
path(f'{APP_NAMES.TEAM_DELETE[APP_NAMES.NAME]}/<str:username>/', views.delete_team,name=APP_NAMES.TEAM_DELETE[APP_NAMES.NAME]),
